...
public sealed class WorksheetLoaderUnitTests
{
    ...
    public void GetColumns_ShouldReturnCorrectColumns()
    {
        ...
        WorksheetLoader<TableItemStub> loader =
            new WorksheetLoader<TableItemStub>(stream, _mockExcelQueryService.Object);
    ...
    public async Task GetColumnsAsync_ShouldReturnCorrectColumns()
    {
        ...
        _mockExcelQueryService.Setup(s => s.QueryAsync(It.IsAny<Stream>(), ExcelType.XLSX))
            .ReturnsAsync(data.AsEnumerable());
    ...
    public void Constructor_ShouldThrowExceptionForInvalidPath()
    {
        ...
        Assert.Throws<FileNotFoundException>(() =>
            new WorksheetLoader<TableItemStub>("invalid_path.xlsx", excelQueryService));
    }
}