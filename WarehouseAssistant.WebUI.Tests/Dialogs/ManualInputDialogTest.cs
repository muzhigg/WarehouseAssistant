...
//
// public sealed class ManualInputDialogTest : MudBlazorTestContext
// {
//     // private Mock<IDialogService> _dialogService;
//     
//     public ManualInputDialogTest()
//     {
...
//         
//         // Act
//         Action act = () => RenderComponent<ManualInputDialog<ICalculatedTableItem>>(parameters => parameters
...
//         
//         // Act
//         var component = RenderComponent<ManualInputDialog<ICalculatedTableItem>>(parameters => parameters
...
//         var cut           = RenderComponent<MudDialogProvider>();
//         DialogParameters<ManualInputDialog<ICalculatedTableItem>> parameters = new()
//         {
...
//             await dialogService!.ShowAsync<ManualInputDialog<ICalculatedTableItem>>("ManualOrderInputDialog",
//                 parameters)));
//         
//         // Assert
...
//         
//         // Act
//         cut.InvokeAsync((async () => ManualInputDialog<ICalculatedTableItem>.Show(
...
//         
//         // Act
//         cut.InvokeAsync((async () => dialogReference = ManualInputDialog<int>.Show(
//             Services.GetService<IDialogService>() as DialogService,
//             mockItem.Object, "Введите количество")));
//         
//         IRenderedComponent<ManualInputDialog<ICalculatedTableItem>> component =
//             cut.FindComponent<ManualInputDialog<ICalculatedTableItem>>();
