...
public class ProductOrderExportDialogTest
{
    ...
    public void DivideProductsIntoOrders_Should_Return_Correct_Orders_And_Products()
    {
        ...
        var tableItems = new List<ProductTableItem>()
        {
            ...
            new ProductTableItem()
            {
                Name = "Товар 2", Article = "40000141", AvailableQuantity = 100000, QuantityToOrder = 220, StockDays = 2
            },
            new ProductTableItem()
            {
                Name = "Товар 3", Article = "40000658", AvailableQuantity = 100000, QuantityToOrder = 245, StockDays = 3
            },
            new ProductTableItem()
            {
                Name = "Товар 4", Article = "40001457", AvailableQuantity = 100000, QuantityToOrder = 123, StockDays = 4
            },
            new ProductTableItem()
            {
        ...
        // Act
        var orders = dialog.DivideProductsIntoOrders(tableItems, dbProducts, 5);
