...
public sealed class ProductsCalculationPageTests : MudBlazorTestContext
{
    ...
    public async Task ShowFileUploadDialog_ShouldShowDialogAndUploadProducts()
    {
        ...
        // Act
        Task showFileUploadDialogTask = component.InvokeAsync(async () => await component.Instance.ShowFileUploadDialogAsync());
    ...
    public async Task ShowCalculatorDialog_ShouldOpenDialogAndReloadData_WhenItemsAreSelectedAndResultIsTrue()
    {
        ...
        // Act
        Task showCalculatorDialogTask = component.InvokeAsync(async () => await component.Instance.ShowCalculatorDialog());
    ...
    public async Task ShowAddToDbDialog_ShouldOpenDialogAndAddProductsToDb()
    {
        ...
        _dialogServiceMock
            .Setup(ds => ds.ShowAsync<AddDbProductDialog>(It.IsAny<string>(), It.IsAny<DialogParameters>()))
            .Returns(async () =>
            {
                await Task.Delay(1000);
                return Mock.Of<IDialogReference>(dr => dr.Result == Task.FromResult(dialogResult));
        ...
        _dialogServiceMock.Verify(ds => ds.ShowAsync<AddDbProductDialog>(
            "Добавить товар",
            It.Is<DialogParameters>(p =>
    ...
    public async Task Should_SetInProgress_When_FileUploadDialogIsOpened()
    {
        ...
        component.Find(".mud-table-loading").Should().NotBeNull("Table should be in loading state while dialog is open");
        ...
        component.Instance.InProgress.Should().BeFalse("Final state of InProgress should be false after operation is complete");
        _dialogServiceMock.Verify(ds => ds.ShowAsync<WorksheetUploadDialog<ProductTableItem>>(It.IsAny<string>(), It.IsAny<DialogParameters>()), Times.Once);
    }
